...
class PremierAddOnPatchResource(ProxyOnlyResource):
    ...
    def __init__(self, kind=None, sku=None, product=None, vendor=None, marketplace_publisher=None, marketplace_offer=None):
        super(PremierAddOnPatchResource, self).__init__(kind=kind)
        self.sku = sku
